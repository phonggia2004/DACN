              ...
              <div class="thum-image">
                <ul id="gallery_01" class="prev-thum">
                  @foreach ($productColor as $color)
                    <li class="sub-img">
                      <a href="javascript:void(0)" data-image="{{ asset("asset/client/images/products/small/$color->img") }}" data-zoom-image="{{ asset("asset/client/images/products/small/$color->img") }}">
          ...
          <div class="tab-box">
            ...
            <div class="tab-content-wrap">
              <div class="tab-content">
                <form method="POST" action="{{ route('product_review.store', $product->id) }}" id="reviewForm">
  @csrf
  <div class="row">
    @if ($checkReviewProduct)
      <div class="col-md-6 col-sm-6">
        <div class="form-row">
          <label class="review-lable">Chọn sao cho sản phẩm</label>

          <div class="rating" id="ratingGroup">
            <input class="star" type="radio" hidden id="star1" name="rating" value="1" {{ old('rating') == 1 ? 'checked' : '' }}/>
            <label for="star1" title="Poor"  id="icon-star1"><i class="fas fa-star"></i></label>

            <input class="star" type="radio" hidden id="star2" name="rating" value="2" {{ old('rating') == 2 ? 'checked' : '' }}/>
            <label for="star2" title="Fair"  id="icon-star2"><i class="fas fa-star"></i></label>

            <input class="star" type="radio" hidden id="star3" name="rating" value="3" {{ old('rating') == 3 ? 'checked' : '' }}/>
            <label for="star3" title="Good"  id="icon-star3"><i class="fas fa-star"></i></label>

            <input class="star" type="radio" hidden id="star4" name="rating" value="4" {{ old('rating') == 4 ? 'checked' : '' }}/>
            <label for="star4" title="Very Good" id="icon-star4"><i class="fas fa-star"></i></label>

            <input class="star" type="radio" hidden id="star5" name="rating" value="5" {{ old('rating') == 5 ? 'checked' : '' }}/>
            <label for="star5" title="Excellent" id="icon-star5"><i class="fas fa-star"></i></label>
          </div>
        ...
        {{-- VIẾT ĐÁNH GIÁ: ẨN CHO TỚI KHI CHỌN SAO --}}
        <div id="reviewBox" class="form-row {{ old('rating') ? '' : 'hidden' }}">
          <label class="review-lable">Nội dung đánh giá</label>
          <textarea style="width: 100%;" name="content" id="content" rows="7" placeholder="Chia sẻ trải nghiệm của bạn...">{{ old('content') }}</textarea>
          ...
          <div class="mt-2">
            <input id="submitBtn" type="submit" value="Đánh Giá" class="submit-review" {{ old('rating') ? '' : 'disabled' }}>
          </div>
        </div>
      </div>
    @endif
