...
<html>
   <head>
      ...
      @vite(['resources/client/css/product.css'])
      @vite(['resources/client/js/aos.js'])
      @vite(['resources/client/js/slider.js'])
   </head>
   <style>
      .thumbnail{
          margin: unset;
   ...
   <body id="home">
     ...
     <script src="/asset/plugins/jquery.mousewheel.min.js"></script>
